...
import { PseProjCnewPage } from "../pageobjects/PseProjCnewPage";
...
type AppFixtures = {
  homePage: HomePage;
  pseProjCnewPage: PseProjCnewPage;
...
export const test = base.extend<AppFixtures>({
  ...
  pseProjCnewPage: async ({ page }, use) => {
    await use(new PseProjCnewPage(page));
  },
