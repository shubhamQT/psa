...
export class SearchResultPage {
  private static readonly L = {
    ...
    assistiveTextIdA0aeead907438ccf198aAa50c7c1ef7c: { strategy: 'css' as const, value: '#assistive-text-id-a0aeead9-0743-8ccf-198a-aa50c7c1ef7c', actionKind: 'text' as const },
  ...
  async clickStageCompletePlanned(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, SearchResultPage.L.stageCompletePlanned));
  }

  async expectStageCompletePlannedVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, SearchResultPage.L.stageCompletePlanned), timeoutMs, soft);
  }

  async clickStageCompleteReadyToStaff(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, SearchResultPage.L.stageCompleteReadyToStaff));
  }

  async expectStageCompleteReadyToStaffVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, SearchResultPage.L.stageCompleteReadyToStaff), timeoutMs, soft);
  }

  async clickStageCompleteInProgress(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, SearchResultPage.L.stageCompleteInProgress));
  }

  async expectStageCompleteInProgressVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, SearchResultPage.L.stageCompleteInProgress), timeoutMs, soft);
  }

  async clickOnHold(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, SearchResultPage.L.onHold));
  }

  async expectOnHoldVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, SearchResultPage.L.onHold), timeoutMs, soft);
  }

  async clickCompleted(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, SearchResultPage.L.completed));
  }

  async expectCompletedVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, SearchResultPage.L.completed), timeoutMs, soft);
  }

  async clickCanceled(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, SearchResultPage.L.canceled));
  }

  async expectCanceledVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, SearchResultPage.L.canceled), timeoutMs, soft);
  }

  async clickOverview(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, SearchResultPage.L.overview));
  }

  async expectOverviewVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, SearchResultPage.L.overview), timeoutMs, soft);
  }

  async clickProjectPlan(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, SearchResultPage.L.projectPlan));
  }

  async expectProjectPlanVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, SearchResultPage.L.projectPlan), timeoutMs, soft);
  }

  async clickGantt(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, SearchResultPage.L.gantt));
  }

  async expectGanttVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, SearchResultPage.L.gantt), timeoutMs, soft);
  }

  async clickResourcePlan(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, SearchResultPage.L.resourcePlan));
  }

  async expectResourcePlanVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, SearchResultPage.L.resourcePlan), timeoutMs, soft);
  }

  async clickFinancials(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, SearchResultPage.L.financials));
  }

  async expectFinancialsVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, SearchResultPage.L.financials), timeoutMs, soft);
  }

  async clickRaidTracker(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, SearchResultPage.L.raidTracker));
  }

  async expectRaidTrackerVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, SearchResultPage.L.raidTracker), timeoutMs, soft);
  }

  async clickProjectSurvey(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, SearchResultPage.L.projectSurvey));
  }

  async expectProjectSurveyVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, SearchResultPage.L.projectSurvey), timeoutMs, soft);
  }

  async clickTeamMembership(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, SearchResultPage.L.teamMembership));
  }

  async expectTeamMembershipVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, SearchResultPage.L.teamMembership), timeoutMs, soft);
  }

  async clickHealthAndCommu(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, SearchResultPage.L.healthAndCommu));
  }

  async expectHealthAndCommuVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, SearchResultPage.L.healthAndCommu), timeoutMs, soft);
  }
  ...
  async getInnerTextAssistiveTextIdA0aeead907438ccf198aAa50c7c1ef7c(): Promise<string> {
    return getTextWhenVisible(webLocator(this.page, SearchResultPage.L.assistiveTextIdA0aeead907438ccf198aAa50c7c1ef7c));
  }

  async expectAssistiveTextIdA0aeead907438ccf198aAa50c7c1ef7cVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, SearchResultPage.L.assistiveTextIdA0aeead907438ccf198aAa50c7c1ef7c), timeoutMs, soft);
  }
  ...
  async doubleClickStageCompletePlanned(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, SearchResultPage.L.stageCompletePlanned));
  }

  async longPressStageCompletePlanned(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, SearchResultPage.L.stageCompletePlanned));
  }

  async expectStageCompletePlannedHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, SearchResultPage.L.stageCompletePlanned), timeoutMs);
  }

  async expectStageCompletePlannedText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, SearchResultPage.L.stageCompletePlanned), expected, timeoutMs);
  }

  async expectStageCompletePlannedContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, SearchResultPage.L.stageCompletePlanned), substring, timeoutMs);
  }

  async expectStageCompletePlannedValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, SearchResultPage.L.stageCompletePlanned), value, timeoutMs);
  }

  async expectStageCompletePlannedEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, SearchResultPage.L.stageCompletePlanned), timeoutMs);
  }

  async expectStageCompletePlannedDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, SearchResultPage.L.stageCompletePlanned), timeoutMs);
  }

  async expectStageCompletePlannedChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, SearchResultPage.L.stageCompletePlanned), timeoutMs);
  }

  async expectStageCompletePlannedUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, SearchResultPage.L.stageCompletePlanned), timeoutMs);
  }

  async expectStageCompletePlannedFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, SearchResultPage.L.stageCompletePlanned), timeoutMs);
  }

  async expectStageCompletePlannedCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, SearchResultPage.L.stageCompletePlanned), count, timeoutMs);
  }

  async scrollStageCompletePlannedIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, SearchResultPage.L.stageCompletePlanned));
  }

  async doubleClickStageCompleteReadyToStaff(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, SearchResultPage.L.stageCompleteReadyToStaff));
  }

  async longPressStageCompleteReadyToStaff(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, SearchResultPage.L.stageCompleteReadyToStaff));
  }

  async expectStageCompleteReadyToStaffHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, SearchResultPage.L.stageCompleteReadyToStaff), timeoutMs);
  }

  async expectStageCompleteReadyToStaffText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, SearchResultPage.L.stageCompleteReadyToStaff), expected, timeoutMs);
  }

  async expectStageCompleteReadyToStaffContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, SearchResultPage.L.stageCompleteReadyToStaff), substring, timeoutMs);
  }

  async expectStageCompleteReadyToStaffValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, SearchResultPage.L.stageCompleteReadyToStaff), value, timeoutMs);
  }

  async expectStageCompleteReadyToStaffEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, SearchResultPage.L.stageCompleteReadyToStaff), timeoutMs);
  }

  async expectStageCompleteReadyToStaffDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, SearchResultPage.L.stageCompleteReadyToStaff), timeoutMs);
  }

  async expectStageCompleteReadyToStaffChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, SearchResultPage.L.stageCompleteReadyToStaff), timeoutMs);
  }

  async expectStageCompleteReadyToStaffUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, SearchResultPage.L.stageCompleteReadyToStaff), timeoutMs);
  }

  async expectStageCompleteReadyToStaffFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, SearchResultPage.L.stageCompleteReadyToStaff), timeoutMs);
  }

  async expectStageCompleteReadyToStaffCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, SearchResultPage.L.stageCompleteReadyToStaff), count, timeoutMs);
  }

  async scrollStageCompleteReadyToStaffIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, SearchResultPage.L.stageCompleteReadyToStaff));
  }

  async doubleClickStageCompleteInProgress(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, SearchResultPage.L.stageCompleteInProgress));
  }

  async longPressStageCompleteInProgress(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, SearchResultPage.L.stageCompleteInProgress));
  }

  async expectStageCompleteInProgressHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, SearchResultPage.L.stageCompleteInProgress), timeoutMs);
  }

  async expectStageCompleteInProgressText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, SearchResultPage.L.stageCompleteInProgress), expected, timeoutMs);
  }

  async expectStageCompleteInProgressContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, SearchResultPage.L.stageCompleteInProgress), substring, timeoutMs);
  }

  async expectStageCompleteInProgressValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, SearchResultPage.L.stageCompleteInProgress), value, timeoutMs);
  }

  async expectStageCompleteInProgressEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, SearchResultPage.L.stageCompleteInProgress), timeoutMs);
  }

  async expectStageCompleteInProgressDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, SearchResultPage.L.stageCompleteInProgress), timeoutMs);
  }

  async expectStageCompleteInProgressChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, SearchResultPage.L.stageCompleteInProgress), timeoutMs);
  }

  async expectStageCompleteInProgressUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, SearchResultPage.L.stageCompleteInProgress), timeoutMs);
  }

  async expectStageCompleteInProgressFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, SearchResultPage.L.stageCompleteInProgress), timeoutMs);
  }

  async expectStageCompleteInProgressCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, SearchResultPage.L.stageCompleteInProgress), count, timeoutMs);
  }

  async scrollStageCompleteInProgressIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, SearchResultPage.L.stageCompleteInProgress));
  }

  async doubleClickOnHold(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, SearchResultPage.L.onHold));
  }

  async longPressOnHold(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, SearchResultPage.L.onHold));
  }

  async expectOnHoldHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, SearchResultPage.L.onHold), timeoutMs);
  }

  async expectOnHoldText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, SearchResultPage.L.onHold), expected, timeoutMs);
  }

  async expectOnHoldContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, SearchResultPage.L.onHold), substring, timeoutMs);
  }

  async expectOnHoldValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, SearchResultPage.L.onHold), value, timeoutMs);
  }

  async expectOnHoldEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, SearchResultPage.L.onHold), timeoutMs);
  }

  async expectOnHoldDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, SearchResultPage.L.onHold), timeoutMs);
  }

  async expectOnHoldChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, SearchResultPage.L.onHold), timeoutMs);
  }

  async expectOnHoldUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, SearchResultPage.L.onHold), timeoutMs);
  }

  async expectOnHoldFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, SearchResultPage.L.onHold), timeoutMs);
  }

  async expectOnHoldCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, SearchResultPage.L.onHold), count, timeoutMs);
  }

  async scrollOnHoldIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, SearchResultPage.L.onHold));
  }

  async doubleClickCompleted(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, SearchResultPage.L.completed));
  }

  async longPressCompleted(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, SearchResultPage.L.completed));
  }

  async expectCompletedHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, SearchResultPage.L.completed), timeoutMs);
  }

  async expectCompletedText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, SearchResultPage.L.completed), expected, timeoutMs);
  }

  async expectCompletedContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, SearchResultPage.L.completed), substring, timeoutMs);
  }

  async expectCompletedValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, SearchResultPage.L.completed), value, timeoutMs);
  }

  async expectCompletedEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, SearchResultPage.L.completed), timeoutMs);
  }

  async expectCompletedDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, SearchResultPage.L.completed), timeoutMs);
  }

  async expectCompletedChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, SearchResultPage.L.completed), timeoutMs);
  }

  async expectCompletedUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, SearchResultPage.L.completed), timeoutMs);
  }

  async expectCompletedFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, SearchResultPage.L.completed), timeoutMs);
  }

  async expectCompletedCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, SearchResultPage.L.completed), count, timeoutMs);
  }

  async scrollCompletedIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, SearchResultPage.L.completed));
  }

  async doubleClickCanceled(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, SearchResultPage.L.canceled));
  }

  async longPressCanceled(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, SearchResultPage.L.canceled));
  }

  async expectCanceledHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, SearchResultPage.L.canceled), timeoutMs);
  }

  async expectCanceledText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, SearchResultPage.L.canceled), expected, timeoutMs);
  }

  async expectCanceledContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, SearchResultPage.L.canceled), substring, timeoutMs);
  }

  async expectCanceledValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, SearchResultPage.L.canceled), value, timeoutMs);
  }

  async expectCanceledEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, SearchResultPage.L.canceled), timeoutMs);
  }

  async expectCanceledDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, SearchResultPage.L.canceled), timeoutMs);
  }

  async expectCanceledChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, SearchResultPage.L.canceled), timeoutMs);
  }

  async expectCanceledUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, SearchResultPage.L.canceled), timeoutMs);
  }

  async expectCanceledFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, SearchResultPage.L.canceled), timeoutMs);
  }

  async expectCanceledCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, SearchResultPage.L.canceled), count, timeoutMs);
  }

  async scrollCanceledIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, SearchResultPage.L.canceled));
  }

  async doubleClickOverview(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, SearchResultPage.L.overview));
  }

  async longPressOverview(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, SearchResultPage.L.overview));
  }

  async expectOverviewHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, SearchResultPage.L.overview), timeoutMs);
  }

  async expectOverviewText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, SearchResultPage.L.overview), expected, timeoutMs);
  }

  async expectOverviewContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, SearchResultPage.L.overview), substring, timeoutMs);
  }

  async expectOverviewValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, SearchResultPage.L.overview), value, timeoutMs);
  }

  async expectOverviewEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, SearchResultPage.L.overview), timeoutMs);
  }

  async expectOverviewDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, SearchResultPage.L.overview), timeoutMs);
  }

  async expectOverviewChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, SearchResultPage.L.overview), timeoutMs);
  }

  async expectOverviewUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, SearchResultPage.L.overview), timeoutMs);
  }

  async expectOverviewFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, SearchResultPage.L.overview), timeoutMs);
  }

  async expectOverviewCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, SearchResultPage.L.overview), count, timeoutMs);
  }

  async scrollOverviewIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, SearchResultPage.L.overview));
  }

  async doubleClickProjectPlan(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, SearchResultPage.L.projectPlan));
  }

  async longPressProjectPlan(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, SearchResultPage.L.projectPlan));
  }

  async expectProjectPlanHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, SearchResultPage.L.projectPlan), timeoutMs);
  }

  async expectProjectPlanText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, SearchResultPage.L.projectPlan), expected, timeoutMs);
  }

  async expectProjectPlanContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, SearchResultPage.L.projectPlan), substring, timeoutMs);
  }

  async expectProjectPlanValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, SearchResultPage.L.projectPlan), value, timeoutMs);
  }

  async expectProjectPlanEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, SearchResultPage.L.projectPlan), timeoutMs);
  }

  async expectProjectPlanDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, SearchResultPage.L.projectPlan), timeoutMs);
  }

  async expectProjectPlanChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, SearchResultPage.L.projectPlan), timeoutMs);
  }

  async expectProjectPlanUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, SearchResultPage.L.projectPlan), timeoutMs);
  }

  async expectProjectPlanFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, SearchResultPage.L.projectPlan), timeoutMs);
  }

  async expectProjectPlanCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, SearchResultPage.L.projectPlan), count, timeoutMs);
  }

  async scrollProjectPlanIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, SearchResultPage.L.projectPlan));
  }

  async doubleClickGantt(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, SearchResultPage.L.gantt));
  }

  async longPressGantt(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, SearchResultPage.L.gantt));
  }

  async expectGanttHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, SearchResultPage.L.gantt), timeoutMs);
  }

  async expectGanttText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, SearchResultPage.L.gantt), expected, timeoutMs);
  }

  async expectGanttContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, SearchResultPage.L.gantt), substring, timeoutMs);
  }

  async expectGanttValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, SearchResultPage.L.gantt), value, timeoutMs);
  }

  async expectGanttEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, SearchResultPage.L.gantt), timeoutMs);
  }

  async expectGanttDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, SearchResultPage.L.gantt), timeoutMs);
  }

  async expectGanttChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, SearchResultPage.L.gantt), timeoutMs);
  }

  async expectGanttUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, SearchResultPage.L.gantt), timeoutMs);
  }

  async expectGanttFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, SearchResultPage.L.gantt), timeoutMs);
  }

  async expectGanttCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, SearchResultPage.L.gantt), count, timeoutMs);
  }

  async scrollGanttIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, SearchResultPage.L.gantt));
  }

  async doubleClickResourcePlan(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, SearchResultPage.L.resourcePlan));
  }

  async longPressResourcePlan(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, SearchResultPage.L.resourcePlan));
  }

  async expectResourcePlanHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, SearchResultPage.L.resourcePlan), timeoutMs);
  }

  async expectResourcePlanText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, SearchResultPage.L.resourcePlan), expected, timeoutMs);
  }

  async expectResourcePlanContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, SearchResultPage.L.resourcePlan), substring, timeoutMs);
  }

  async expectResourcePlanValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, SearchResultPage.L.resourcePlan), value, timeoutMs);
  }

  async expectResourcePlanEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, SearchResultPage.L.resourcePlan), timeoutMs);
  }

  async expectResourcePlanDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, SearchResultPage.L.resourcePlan), timeoutMs);
  }

  async expectResourcePlanChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, SearchResultPage.L.resourcePlan), timeoutMs);
  }

  async expectResourcePlanUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, SearchResultPage.L.resourcePlan), timeoutMs);
  }

  async expectResourcePlanFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, SearchResultPage.L.resourcePlan), timeoutMs);
  }

  async expectResourcePlanCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, SearchResultPage.L.resourcePlan), count, timeoutMs);
  }

  async scrollResourcePlanIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, SearchResultPage.L.resourcePlan));
  }

  async doubleClickFinancials(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, SearchResultPage.L.financials));
  }

  async longPressFinancials(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, SearchResultPage.L.financials));
  }

  async expectFinancialsHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, SearchResultPage.L.financials), timeoutMs);
  }

  async expectFinancialsText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, SearchResultPage.L.financials), expected, timeoutMs);
  }

  async expectFinancialsContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, SearchResultPage.L.financials), substring, timeoutMs);
  }

  async expectFinancialsValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, SearchResultPage.L.financials), value, timeoutMs);
  }

  async expectFinancialsEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, SearchResultPage.L.financials), timeoutMs);
  }

  async expectFinancialsDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, SearchResultPage.L.financials), timeoutMs);
  }

  async expectFinancialsChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, SearchResultPage.L.financials), timeoutMs);
  }

  async expectFinancialsUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, SearchResultPage.L.financials), timeoutMs);
  }

  async expectFinancialsFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, SearchResultPage.L.financials), timeoutMs);
  }

  async expectFinancialsCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, SearchResultPage.L.financials), count, timeoutMs);
  }

  async scrollFinancialsIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, SearchResultPage.L.financials));
  }

  async doubleClickRaidTracker(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, SearchResultPage.L.raidTracker));
  }

  async longPressRaidTracker(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, SearchResultPage.L.raidTracker));
  }

  async expectRaidTrackerHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, SearchResultPage.L.raidTracker), timeoutMs);
  }

  async expectRaidTrackerText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, SearchResultPage.L.raidTracker), expected, timeoutMs);
  }

  async expectRaidTrackerContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, SearchResultPage.L.raidTracker), substring, timeoutMs);
  }

  async expectRaidTrackerValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, SearchResultPage.L.raidTracker), value, timeoutMs);
  }

  async expectRaidTrackerEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, SearchResultPage.L.raidTracker), timeoutMs);
  }

  async expectRaidTrackerDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, SearchResultPage.L.raidTracker), timeoutMs);
  }

  async expectRaidTrackerChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, SearchResultPage.L.raidTracker), timeoutMs);
  }

  async expectRaidTrackerUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, SearchResultPage.L.raidTracker), timeoutMs);
  }

  async expectRaidTrackerFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, SearchResultPage.L.raidTracker), timeoutMs);
  }

  async expectRaidTrackerCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, SearchResultPage.L.raidTracker), count, timeoutMs);
  }

  async scrollRaidTrackerIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, SearchResultPage.L.raidTracker));
  }

  async doubleClickProjectSurvey(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, SearchResultPage.L.projectSurvey));
  }

  async longPressProjectSurvey(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, SearchResultPage.L.projectSurvey));
  }

  async expectProjectSurveyHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, SearchResultPage.L.projectSurvey), timeoutMs);
  }

  async expectProjectSurveyText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, SearchResultPage.L.projectSurvey), expected, timeoutMs);
  }

  async expectProjectSurveyContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, SearchResultPage.L.projectSurvey), substring, timeoutMs);
  }

  async expectProjectSurveyValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, SearchResultPage.L.projectSurvey), value, timeoutMs);
  }

  async expectProjectSurveyEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, SearchResultPage.L.projectSurvey), timeoutMs);
  }

  async expectProjectSurveyDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, SearchResultPage.L.projectSurvey), timeoutMs);
  }

  async expectProjectSurveyChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, SearchResultPage.L.projectSurvey), timeoutMs);
  }

  async expectProjectSurveyUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, SearchResultPage.L.projectSurvey), timeoutMs);
  }

  async expectProjectSurveyFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, SearchResultPage.L.projectSurvey), timeoutMs);
  }

  async expectProjectSurveyCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, SearchResultPage.L.projectSurvey), count, timeoutMs);
  }

  async scrollProjectSurveyIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, SearchResultPage.L.projectSurvey));
  }

  async doubleClickTeamMembership(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, SearchResultPage.L.teamMembership));
  }

  async longPressTeamMembership(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, SearchResultPage.L.teamMembership));
  }

  async expectTeamMembershipHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, SearchResultPage.L.teamMembership), timeoutMs);
  }

  async expectTeamMembershipText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, SearchResultPage.L.teamMembership), expected, timeoutMs);
  }

  async expectTeamMembershipContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, SearchResultPage.L.teamMembership), substring, timeoutMs);
  }

  async expectTeamMembershipValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, SearchResultPage.L.teamMembership), value, timeoutMs);
  }

  async expectTeamMembershipEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, SearchResultPage.L.teamMembership), timeoutMs);
  }

  async expectTeamMembershipDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, SearchResultPage.L.teamMembership), timeoutMs);
  }

  async expectTeamMembershipChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, SearchResultPage.L.teamMembership), timeoutMs);
  }

  async expectTeamMembershipUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, SearchResultPage.L.teamMembership), timeoutMs);
  }

  async expectTeamMembershipFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, SearchResultPage.L.teamMembership), timeoutMs);
  }

  async expectTeamMembershipCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, SearchResultPage.L.teamMembership), count, timeoutMs);
  }

  async scrollTeamMembershipIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, SearchResultPage.L.teamMembership));
  }

  async doubleClickHealthAndCommu(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, SearchResultPage.L.healthAndCommu));
  }

  async longPressHealthAndCommu(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, SearchResultPage.L.healthAndCommu));
  }

  async expectHealthAndCommuHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, SearchResultPage.L.healthAndCommu), timeoutMs);
  }

  async expectHealthAndCommuText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, SearchResultPage.L.healthAndCommu), expected, timeoutMs);
  }

  async expectHealthAndCommuContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, SearchResultPage.L.healthAndCommu), substring, timeoutMs);
  }

  async expectHealthAndCommuValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, SearchResultPage.L.healthAndCommu), value, timeoutMs);
  }

  async expectHealthAndCommuEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, SearchResultPage.L.healthAndCommu), timeoutMs);
  }

  async expectHealthAndCommuDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, SearchResultPage.L.healthAndCommu), timeoutMs);
  }

  async expectHealthAndCommuChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, SearchResultPage.L.healthAndCommu), timeoutMs);
  }

  async expectHealthAndCommuUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, SearchResultPage.L.healthAndCommu), timeoutMs);
  }

  async expectHealthAndCommuFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, SearchResultPage.L.healthAndCommu), timeoutMs);
  }

  async expectHealthAndCommuCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, SearchResultPage.L.healthAndCommu), count, timeoutMs);
  }

  async scrollHealthAndCommuIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, SearchResultPage.L.healthAndCommu));
  }
  ...
  async clickAssistiveTextIdA0aeead907438ccf198aAa50c7c1ef7c(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, SearchResultPage.L.assistiveTextIdA0aeead907438ccf198aAa50c7c1ef7c));
  }

  async doubleClickAssistiveTextIdA0aeead907438ccf198aAa50c7c1ef7c(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, SearchResultPage.L.assistiveTextIdA0aeead907438ccf198aAa50c7c1ef7c));
  }

  async longPressAssistiveTextIdA0aeead907438ccf198aAa50c7c1ef7c(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, SearchResultPage.L.assistiveTextIdA0aeead907438ccf198aAa50c7c1ef7c));
  }

  async expectAssistiveTextIdA0aeead907438ccf198aAa50c7c1ef7cHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, SearchResultPage.L.assistiveTextIdA0aeead907438ccf198aAa50c7c1ef7c), timeoutMs);
  }

  async expectAssistiveTextIdA0aeead907438ccf198aAa50c7c1ef7cText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, SearchResultPage.L.assistiveTextIdA0aeead907438ccf198aAa50c7c1ef7c), expected, timeoutMs);
  }

  async expectAssistiveTextIdA0aeead907438ccf198aAa50c7c1ef7cContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, SearchResultPage.L.assistiveTextIdA0aeead907438ccf198aAa50c7c1ef7c), substring, timeoutMs);
  }

  async expectAssistiveTextIdA0aeead907438ccf198aAa50c7c1ef7cValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, SearchResultPage.L.assistiveTextIdA0aeead907438ccf198aAa50c7c1ef7c), value, timeoutMs);
  }

  async expectAssistiveTextIdA0aeead907438ccf198aAa50c7c1ef7cEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, SearchResultPage.L.assistiveTextIdA0aeead907438ccf198aAa50c7c1ef7c), timeoutMs);
  }

  async expectAssistiveTextIdA0aeead907438ccf198aAa50c7c1ef7cDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, SearchResultPage.L.assistiveTextIdA0aeead907438ccf198aAa50c7c1ef7c), timeoutMs);
  }

  async expectAssistiveTextIdA0aeead907438ccf198aAa50c7c1ef7cChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, SearchResultPage.L.assistiveTextIdA0aeead907438ccf198aAa50c7c1ef7c), timeoutMs);
  }

  async expectAssistiveTextIdA0aeead907438ccf198aAa50c7c1ef7cUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, SearchResultPage.L.assistiveTextIdA0aeead907438ccf198aAa50c7c1ef7c), timeoutMs);
  }

  async expectAssistiveTextIdA0aeead907438ccf198aAa50c7c1ef7cFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, SearchResultPage.L.assistiveTextIdA0aeead907438ccf198aAa50c7c1ef7c), timeoutMs);
  }

  async expectAssistiveTextIdA0aeead907438ccf198aAa50c7c1ef7cCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, SearchResultPage.L.assistiveTextIdA0aeead907438ccf198aAa50c7c1ef7c), count, timeoutMs);
  }

  async scrollAssistiveTextIdA0aeead907438ccf198aAa50c7c1ef7cIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, SearchResultPage.L.assistiveTextIdA0aeead907438ccf198aAa50c7c1ef7c));
  }
