...
export class HomePage {
  private static readonly L = {
    ...
    updatedAnHourAgo: { strategy: 'text' as const, value: 'Updated an hour ago', shadowHost: 'force-list-view-manager-status-info', actionKind: 'text' as const },
    ...
    homeCardHeader4730: { strategy: 'css' as const, value: '#homeCardHeader_473:0', actionKind: 'text' as const },
    ayushPuranik: { strategy: 'role' as const, value: 'Ayush Puranik', role: 'link', actionKind: 'link' as const },
    mollieWatts: { strategy: 'role' as const, value: 'Mollie Watts', role: 'link', actionKind: 'link' as const },
    foundRentalReady: { strategy: 'role' as const, value: 'Found Rental - Ready - 225EE', role: 'link', actionKind: 'link' as const },
    nikeInc: { strategy: 'role' as const, value: 'NIKE INC.', role: 'link', actionKind: 'link' as const },
    healthAndCommu: { strategy: 'text' as const, value: '360 HEALTH AND COMMU - Q-383470 - Ready Fixed Fee Implementation', actionKind: 'link' as const },
    ...
    userConsultant: { strategy: 'text' as const, value: 'User • Consultant', shadowHost: 'lightning-formatted-rich-text', actionKind: 'text' as const },
    userLeadResource: { strategy: 'text' as const, value: 'User • Lead Resource Manager', shadowHost: 'lightning-formatted-rich-text', actionKind: 'text' as const },
    opportunityFoundRental: { strategy: 'text' as const, value: 'Opportunity • Found Rental Co.', shadowHost: 'lightning-formatted-rich-text', actionKind: 'text' as const },
    account: { strategy: 'text' as const, value: 'Account', shadowHost: 'lightning-formatted-rich-text', actionKind: 'text' as const },
    project: { strategy: 'text' as const, value: 'Project', shadowHost: 'lightning-formatted-rich-text', actionKind: 'text' as const },
    tasksList: { strategy: 'text' as const, value: 'Tasks List', shadowHost: 'lightning-formatted-rich-text', actionKind: 'text' as const },
    builders: { strategy: 'text' as const, value: 'Builders', shadowHost: 'lightning-formatted-rich-text', actionKind: 'text' as const },
    peopleList: { strategy: 'text' as const, value: 'People List', shadowHost: 'lightning-formatted-rich-text', actionKind: 'text' as const },
    all: { strategy: 'text' as const, value: 'All', shadowHost: 'lightning-formatted-rich-text', actionKind: 'text' as const },
    accountNameCases: { strategy: 'text' as const, value: '"[account name] cases"', shadowHost: '#preview', actionKind: 'text' as const },
    cases: { strategy: 'text' as const, value: '"[] cases"', shadowHost: 'lightning-formatted-rich-text', actionKind: 'text' as const },
    userNameLeads: { strategy: 'text' as const, value: '"[user name] leads"', shadowHost: '#preview', actionKind: 'text' as const },
    leads: { strategy: 'text' as const, value: '"[] leads"', shadowHost: 'lightning-formatted-rich-text', actionKind: 'text' as const },
    getInsights: { strategy: 'text' as const, value: 'Get insights', shadowHost: '#preview', actionKind: 'text' as const },
    leadsInPortland: { strategy: 'text' as const, value: '"leads in Portland"', shadowHost: '#preview', actionKind: 'text' as const },
    contactsInCalifornia: { strategy: 'text' as const, value: '"contacts in California"', shadowHost: '#preview', actionKind: 'text' as const },
    learnMoreAboutNatural: { strategy: 'role' as const, value: 'Learn More', role: 'link', shadowHost: 'forcehelp-link', actionKind: 'link' as const },
  } as const;
  ...
  async getInnerTextUpdatedAnHourAgo(): Promise<string> {
    return getTextWhenVisible(webLocator(this.page, HomePage.L.updatedAnHourAgo));
  }

  async expectUpdatedAnHourAgoVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.updatedAnHourAgo), timeoutMs, soft);
  }
  ...
  async getInnerTextHomeCardHeader4730(): Promise<string> {
    return getTextWhenVisible(webLocator(this.page, HomePage.L.homeCardHeader4730));
  }

  async expectHomeCardHeader4730Visible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.homeCardHeader4730), timeoutMs, soft);
  }
  ...
  async clickMollieWatts(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.mollieWatts));
  }

  async expectMollieWattsVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.mollieWatts), timeoutMs, soft);
  }
  ...
  async clickNikeInc(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.nikeInc));
  }

  async expectNikeIncVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.nikeInc), timeoutMs, soft);
  }

  async clickHealthAndCommu(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.healthAndCommu));
  }

  async expectHealthAndCommuVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.healthAndCommu), timeoutMs, soft);
  }
  ...
  async getInnerTextUserConsultant(): Promise<string> {
    return getTextWhenVisible(webLocator(this.page, HomePage.L.userConsultant));
  }

  async expectUserConsultantVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.userConsultant), timeoutMs, soft);
  }

  async getInnerTextUserLeadResource(): Promise<string> {
    return getTextWhenVisible(webLocator(this.page, HomePage.L.userLeadResource));
  }

  async expectUserLeadResourceVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.userLeadResource), timeoutMs, soft);
  }

  async getInnerTextOpportunityFoundRental(): Promise<string> {
    return getTextWhenVisible(webLocator(this.page, HomePage.L.opportunityFoundRental));
  }

  async expectOpportunityFoundRentalVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.opportunityFoundRental), timeoutMs, soft);
  }

  async getInnerTextAccount(): Promise<string> {
    return getTextWhenVisible(webLocator(this.page, HomePage.L.account));
  }

  async expectAccountVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.account), timeoutMs, soft);
  }

  async getInnerTextProject(): Promise<string> {
    return getTextWhenVisible(webLocator(this.page, HomePage.L.project));
  }

  async expectProjectVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.project), timeoutMs, soft);
  }

  async getInnerTextTasksList(): Promise<string> {
    return getTextWhenVisible(webLocator(this.page, HomePage.L.tasksList));
  }

  async expectTasksListVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.tasksList), timeoutMs, soft);
  }

  async getInnerTextBuilders(): Promise<string> {
    return getTextWhenVisible(webLocator(this.page, HomePage.L.builders));
  }

  async expectBuildersVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.builders), timeoutMs, soft);
  }

  async getInnerTextPeopleList(): Promise<string> {
    return getTextWhenVisible(webLocator(this.page, HomePage.L.peopleList));
  }

  async expectPeopleListVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.peopleList), timeoutMs, soft);
  }

  async getInnerTextAll(): Promise<string> {
    return getTextWhenVisible(webLocator(this.page, HomePage.L.all));
  }

  async expectAllVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.all), timeoutMs, soft);
  }

  async getInnerTextAccountNameCases(): Promise<string> {
    return getTextWhenVisible(webLocator(this.page, HomePage.L.accountNameCases));
  }

  async expectAccountNameCasesVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.accountNameCases), timeoutMs, soft);
  }

  async getInnerTextCases(): Promise<string> {
    return getTextWhenVisible(webLocator(this.page, HomePage.L.cases));
  }

  async expectCasesVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.cases), timeoutMs, soft);
  }

  async getInnerTextUserNameLeads(): Promise<string> {
    return getTextWhenVisible(webLocator(this.page, HomePage.L.userNameLeads));
  }

  async expectUserNameLeadsVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.userNameLeads), timeoutMs, soft);
  }

  async getInnerTextLeads(): Promise<string> {
    return getTextWhenVisible(webLocator(this.page, HomePage.L.leads));
  }
  ...
  async getInnerTextGetInsights(): Promise<string> {
    return getTextWhenVisible(webLocator(this.page, HomePage.L.getInsights));
  }

  async expectGetInsightsVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.getInsights), timeoutMs, soft);
  }

  async getInnerTextLeadsInPortland(): Promise<string> {
    return getTextWhenVisible(webLocator(this.page, HomePage.L.leadsInPortland));
  }

  async expectLeadsInPortlandVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.leadsInPortland), timeoutMs, soft);
  }

  async getInnerTextContactsInCalifornia(): Promise<string> {
    return getTextWhenVisible(webLocator(this.page, HomePage.L.contactsInCalifornia));
  }

  async expectContactsInCaliforniaVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.contactsInCalifornia), timeoutMs, soft);
  }

  async clickLearnMoreAboutNatural(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.learnMoreAboutNatural));
  }

  async expectLearnMoreAboutNaturalVisible(timeoutMs = 30_000, soft = true): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.learnMoreAboutNatural), timeoutMs, soft);
  }
  ...
  async clickUpdatedAnHourAgo(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.updatedAnHourAgo));
  }

  async doubleClickUpdatedAnHourAgo(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.updatedAnHourAgo));
  }

  async longPressUpdatedAnHourAgo(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.updatedAnHourAgo));
  }

  async expectUpdatedAnHourAgoHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.updatedAnHourAgo), timeoutMs);
  }

  async expectUpdatedAnHourAgoText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.updatedAnHourAgo), expected, timeoutMs);
  }

  async expectUpdatedAnHourAgoContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.updatedAnHourAgo), substring, timeoutMs);
  }

  async expectUpdatedAnHourAgoValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.updatedAnHourAgo), value, timeoutMs);
  }

  async expectUpdatedAnHourAgoEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.updatedAnHourAgo), timeoutMs);
  }

  async expectUpdatedAnHourAgoDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.updatedAnHourAgo), timeoutMs);
  }

  async expectUpdatedAnHourAgoChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.updatedAnHourAgo), timeoutMs);
  }

  async expectUpdatedAnHourAgoUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.updatedAnHourAgo), timeoutMs);
  }

  async expectUpdatedAnHourAgoFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.updatedAnHourAgo), timeoutMs);
  }

  async expectUpdatedAnHourAgoCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.updatedAnHourAgo), count, timeoutMs);
  }

  async scrollUpdatedAnHourAgoIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.updatedAnHourAgo));
  }
  ...
  async clickHomeCardHeader4730(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.homeCardHeader4730));
  }

  async doubleClickHomeCardHeader4730(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.homeCardHeader4730));
  }

  async longPressHomeCardHeader4730(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.homeCardHeader4730));
  }

  async expectHomeCardHeader4730Hidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.homeCardHeader4730), timeoutMs);
  }

  async expectHomeCardHeader4730Text(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.homeCardHeader4730), expected, timeoutMs);
  }

  async expectHomeCardHeader4730ContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.homeCardHeader4730), substring, timeoutMs);
  }

  async expectHomeCardHeader4730Value(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.homeCardHeader4730), value, timeoutMs);
  }

  async expectHomeCardHeader4730Enabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.homeCardHeader4730), timeoutMs);
  }

  async expectHomeCardHeader4730Disabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.homeCardHeader4730), timeoutMs);
  }

  async expectHomeCardHeader4730Checked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.homeCardHeader4730), timeoutMs);
  }

  async expectHomeCardHeader4730Unchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.homeCardHeader4730), timeoutMs);
  }

  async expectHomeCardHeader4730Focused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.homeCardHeader4730), timeoutMs);
  }

  async expectHomeCardHeader4730Count(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.homeCardHeader4730), count, timeoutMs);
  }

  async scrollHomeCardHeader4730IntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.homeCardHeader4730));
  }
  ...
  async doubleClickMollieWatts(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.mollieWatts));
  }

  async longPressMollieWatts(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.mollieWatts));
  }

  async expectMollieWattsHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.mollieWatts), timeoutMs);
  }

  async expectMollieWattsText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.mollieWatts), expected, timeoutMs);
  }

  async expectMollieWattsContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.mollieWatts), substring, timeoutMs);
  }

  async expectMollieWattsValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.mollieWatts), value, timeoutMs);
  }

  async expectMollieWattsEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.mollieWatts), timeoutMs);
  }

  async expectMollieWattsDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.mollieWatts), timeoutMs);
  }

  async expectMollieWattsChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.mollieWatts), timeoutMs);
  }

  async expectMollieWattsUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.mollieWatts), timeoutMs);
  }

  async expectMollieWattsFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.mollieWatts), timeoutMs);
  }

  async expectMollieWattsCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.mollieWatts), count, timeoutMs);
  }

  async scrollMollieWattsIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.mollieWatts));
  }
  ...
  async doubleClickNikeInc(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.nikeInc));
  }

  async longPressNikeInc(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.nikeInc));
  }

  async expectNikeIncHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.nikeInc), timeoutMs);
  }

  async expectNikeIncText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.nikeInc), expected, timeoutMs);
  }

  async expectNikeIncContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.nikeInc), substring, timeoutMs);
  }

  async expectNikeIncValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.nikeInc), value, timeoutMs);
  }

  async expectNikeIncEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.nikeInc), timeoutMs);
  }

  async expectNikeIncDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.nikeInc), timeoutMs);
  }

  async expectNikeIncChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.nikeInc), timeoutMs);
  }

  async expectNikeIncUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.nikeInc), timeoutMs);
  }

  async expectNikeIncFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.nikeInc), timeoutMs);
  }

  async expectNikeIncCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.nikeInc), count, timeoutMs);
  }

  async scrollNikeIncIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.nikeInc));
  }

  async doubleClickHealthAndCommu(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.healthAndCommu));
  }

  async longPressHealthAndCommu(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.healthAndCommu));
  }

  async expectHealthAndCommuHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.healthAndCommu), timeoutMs);
  }

  async expectHealthAndCommuText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.healthAndCommu), expected, timeoutMs);
  }

  async expectHealthAndCommuContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.healthAndCommu), substring, timeoutMs);
  }

  async expectHealthAndCommuValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.healthAndCommu), value, timeoutMs);
  }

  async expectHealthAndCommuEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.healthAndCommu), timeoutMs);
  }

  async expectHealthAndCommuDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.healthAndCommu), timeoutMs);
  }

  async expectHealthAndCommuChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.healthAndCommu), timeoutMs);
  }

  async expectHealthAndCommuUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.healthAndCommu), timeoutMs);
  }

  async expectHealthAndCommuFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.healthAndCommu), timeoutMs);
  }

  async expectHealthAndCommuCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.healthAndCommu), count, timeoutMs);
  }

  async scrollHealthAndCommuIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.healthAndCommu));
  }
  ...
  async clickUserConsultant(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.userConsultant));
  }

  async doubleClickUserConsultant(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.userConsultant));
  }

  async longPressUserConsultant(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.userConsultant));
  }

  async expectUserConsultantHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.userConsultant), timeoutMs);
  }

  async expectUserConsultantText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.userConsultant), expected, timeoutMs);
  }

  async expectUserConsultantContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.userConsultant), substring, timeoutMs);
  }

  async expectUserConsultantValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.userConsultant), value, timeoutMs);
  }

  async expectUserConsultantEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.userConsultant), timeoutMs);
  }

  async expectUserConsultantDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.userConsultant), timeoutMs);
  }

  async expectUserConsultantChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.userConsultant), timeoutMs);
  }

  async expectUserConsultantUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.userConsultant), timeoutMs);
  }

  async expectUserConsultantFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.userConsultant), timeoutMs);
  }

  async expectUserConsultantCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.userConsultant), count, timeoutMs);
  }

  async scrollUserConsultantIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.userConsultant));
  }

  async clickUserLeadResource(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.userLeadResource));
  }

  async doubleClickUserLeadResource(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.userLeadResource));
  }

  async longPressUserLeadResource(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.userLeadResource));
  }

  async expectUserLeadResourceHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.userLeadResource), timeoutMs);
  }

  async expectUserLeadResourceText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.userLeadResource), expected, timeoutMs);
  }

  async expectUserLeadResourceContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.userLeadResource), substring, timeoutMs);
  }

  async expectUserLeadResourceValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.userLeadResource), value, timeoutMs);
  }

  async expectUserLeadResourceEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.userLeadResource), timeoutMs);
  }

  async expectUserLeadResourceDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.userLeadResource), timeoutMs);
  }

  async expectUserLeadResourceChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.userLeadResource), timeoutMs);
  }

  async expectUserLeadResourceUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.userLeadResource), timeoutMs);
  }

  async expectUserLeadResourceFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.userLeadResource), timeoutMs);
  }

  async expectUserLeadResourceCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.userLeadResource), count, timeoutMs);
  }

  async scrollUserLeadResourceIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.userLeadResource));
  }

  async clickOpportunityFoundRental(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.opportunityFoundRental));
  }

  async doubleClickOpportunityFoundRental(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.opportunityFoundRental));
  }

  async longPressOpportunityFoundRental(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.opportunityFoundRental));
  }

  async expectOpportunityFoundRentalHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.opportunityFoundRental), timeoutMs);
  }

  async expectOpportunityFoundRentalText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.opportunityFoundRental), expected, timeoutMs);
  }

  async expectOpportunityFoundRentalContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.opportunityFoundRental), substring, timeoutMs);
  }

  async expectOpportunityFoundRentalValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.opportunityFoundRental), value, timeoutMs);
  }

  async expectOpportunityFoundRentalEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.opportunityFoundRental), timeoutMs);
  }

  async expectOpportunityFoundRentalDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.opportunityFoundRental), timeoutMs);
  }

  async expectOpportunityFoundRentalChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.opportunityFoundRental), timeoutMs);
  }

  async expectOpportunityFoundRentalUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.opportunityFoundRental), timeoutMs);
  }

  async expectOpportunityFoundRentalFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.opportunityFoundRental), timeoutMs);
  }

  async expectOpportunityFoundRentalCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.opportunityFoundRental), count, timeoutMs);
  }

  async scrollOpportunityFoundRentalIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.opportunityFoundRental));
  }

  async clickAccount(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.account));
  }

  async doubleClickAccount(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.account));
  }

  async longPressAccount(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.account));
  }

  async expectAccountHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.account), timeoutMs);
  }

  async expectAccountText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.account), expected, timeoutMs);
  }

  async expectAccountContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.account), substring, timeoutMs);
  }

  async expectAccountValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.account), value, timeoutMs);
  }

  async expectAccountEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.account), timeoutMs);
  }

  async expectAccountDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.account), timeoutMs);
  }

  async expectAccountChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.account), timeoutMs);
  }

  async expectAccountUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.account), timeoutMs);
  }

  async expectAccountFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.account), timeoutMs);
  }

  async expectAccountCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.account), count, timeoutMs);
  }

  async scrollAccountIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.account));
  }

  async clickProject(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.project));
  }

  async doubleClickProject(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.project));
  }

  async longPressProject(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.project));
  }

  async expectProjectHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.project), timeoutMs);
  }

  async expectProjectText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.project), expected, timeoutMs);
  }

  async expectProjectContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.project), substring, timeoutMs);
  }

  async expectProjectValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.project), value, timeoutMs);
  }

  async expectProjectEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.project), timeoutMs);
  }

  async expectProjectDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.project), timeoutMs);
  }

  async expectProjectChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.project), timeoutMs);
  }

  async expectProjectUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.project), timeoutMs);
  }

  async expectProjectFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.project), timeoutMs);
  }

  async expectProjectCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.project), count, timeoutMs);
  }

  async scrollProjectIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.project));
  }
  ...
  async clickBuilders(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.builders));
  }

  async doubleClickBuilders(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.builders));
  }

  async longPressBuilders(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.builders));
  }

  async expectBuildersHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.builders), timeoutMs);
  }

  async expectBuildersText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.builders), expected, timeoutMs);
  }

  async expectBuildersContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.builders), substring, timeoutMs);
  }

  async expectBuildersValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.builders), value, timeoutMs);
  }

  async expectBuildersEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.builders), timeoutMs);
  }

  async expectBuildersDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.builders), timeoutMs);
  }

  async expectBuildersChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.builders), timeoutMs);
  }

  async expectBuildersUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.builders), timeoutMs);
  }

  async expectBuildersFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.builders), timeoutMs);
  }

  async expectBuildersCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.builders), count, timeoutMs);
  }

  async scrollBuildersIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.builders));
  }

  async clickPeopleList(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.peopleList));
  }

  async doubleClickPeopleList(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.peopleList));
  }

  async longPressPeopleList(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.peopleList));
  }

  async expectPeopleListHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.peopleList), timeoutMs);
  }

  async expectPeopleListText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.peopleList), expected, timeoutMs);
  }

  async expectPeopleListContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.peopleList), substring, timeoutMs);
  }

  async expectPeopleListValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.peopleList), value, timeoutMs);
  }

  async expectPeopleListEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.peopleList), timeoutMs);
  }

  async expectPeopleListDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.peopleList), timeoutMs);
  }

  async expectPeopleListChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.peopleList), timeoutMs);
  }

  async expectPeopleListUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.peopleList), timeoutMs);
  }

  async expectPeopleListFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.peopleList), timeoutMs);
  }

  async expectPeopleListCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.peopleList), count, timeoutMs);
  }

  async scrollPeopleListIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.peopleList));
  }

  async clickAll(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.all));
  }

  async doubleClickAll(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.all));
  }

  async longPressAll(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.all));
  }

  async expectAllHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.all), timeoutMs);
  }

  async expectAllText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.all), expected, timeoutMs);
  }

  async expectAllContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.all), substring, timeoutMs);
  }

  async expectAllValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.all), value, timeoutMs);
  }

  async expectAllEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.all), timeoutMs);
  }

  async expectAllDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.all), timeoutMs);
  }

  async expectAllChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.all), timeoutMs);
  }

  async expectAllUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.all), timeoutMs);
  }

  async expectAllFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.all), timeoutMs);
  }

  async expectAllCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.all), count, timeoutMs);
  }

  async scrollAllIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.all));
  }

  async clickAccountNameCases(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.accountNameCases));
  }

  async doubleClickAccountNameCases(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.accountNameCases));
  }

  async longPressAccountNameCases(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.accountNameCases));
  }

  async expectAccountNameCasesHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.accountNameCases), timeoutMs);
  }

  async expectAccountNameCasesText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.accountNameCases), expected, timeoutMs);
  }

  async expectAccountNameCasesContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.accountNameCases), substring, timeoutMs);
  }

  async expectAccountNameCasesValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.accountNameCases), value, timeoutMs);
  }

  async expectAccountNameCasesEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.accountNameCases), timeoutMs);
  }

  async expectAccountNameCasesDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.accountNameCases), timeoutMs);
  }

  async expectAccountNameCasesChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.accountNameCases), timeoutMs);
  }

  async expectAccountNameCasesUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.accountNameCases), timeoutMs);
  }

  async expectAccountNameCasesFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.accountNameCases), timeoutMs);
  }

  async expectAccountNameCasesCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.accountNameCases), count, timeoutMs);
  }

  async scrollAccountNameCasesIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.accountNameCases));
  }

  async clickCases(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.cases));
  }

  async doubleClickCases(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.cases));
  }

  async longPressCases(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.cases));
  }

  async expectCasesHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.cases), timeoutMs);
  }

  async expectCasesText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.cases), expected, timeoutMs);
  }

  async expectCasesContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.cases), substring, timeoutMs);
  }

  async expectCasesValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.cases), value, timeoutMs);
  }

  async expectCasesEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.cases), timeoutMs);
  }

  async expectCasesDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.cases), timeoutMs);
  }

  async expectCasesChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.cases), timeoutMs);
  }

  async expectCasesUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.cases), timeoutMs);
  }

  async expectCasesFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.cases), timeoutMs);
  }

  async expectCasesCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.cases), count, timeoutMs);
  }

  async scrollCasesIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.cases));
  }

  async clickUserNameLeads(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.userNameLeads));
  }

  async doubleClickUserNameLeads(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.userNameLeads));
  }

  async longPressUserNameLeads(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.userNameLeads));
  }

  async expectUserNameLeadsHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.userNameLeads), timeoutMs);
  }

  async expectUserNameLeadsText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.userNameLeads), expected, timeoutMs);
  }

  async expectUserNameLeadsContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.userNameLeads), substring, timeoutMs);
  }

  async expectUserNameLeadsValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.userNameLeads), value, timeoutMs);
  }

  async expectUserNameLeadsEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.userNameLeads), timeoutMs);
  }

  async expectUserNameLeadsDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.userNameLeads), timeoutMs);
  }

  async expectUserNameLeadsChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.userNameLeads), timeoutMs);
  }

  async expectUserNameLeadsUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.userNameLeads), timeoutMs);
  }

  async expectUserNameLeadsFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.userNameLeads), timeoutMs);
  }

  async expectUserNameLeadsCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.userNameLeads), count, timeoutMs);
  }

  async scrollUserNameLeadsIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.userNameLeads));
  }
  ...
  async clickGetInsights(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.getInsights));
  }

  async doubleClickGetInsights(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.getInsights));
  }

  async longPressGetInsights(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.getInsights));
  }

  async expectGetInsightsHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.getInsights), timeoutMs);
  }

  async expectGetInsightsText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.getInsights), expected, timeoutMs);
  }

  async expectGetInsightsContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.getInsights), substring, timeoutMs);
  }

  async expectGetInsightsValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.getInsights), value, timeoutMs);
  }

  async expectGetInsightsEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.getInsights), timeoutMs);
  }

  async expectGetInsightsDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.getInsights), timeoutMs);
  }

  async expectGetInsightsChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.getInsights), timeoutMs);
  }

  async expectGetInsightsUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.getInsights), timeoutMs);
  }

  async expectGetInsightsFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.getInsights), timeoutMs);
  }

  async expectGetInsightsCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.getInsights), count, timeoutMs);
  }

  async scrollGetInsightsIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.getInsights));
  }

  async clickLeadsInPortland(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.leadsInPortland));
  }

  async doubleClickLeadsInPortland(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.leadsInPortland));
  }

  async longPressLeadsInPortland(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.leadsInPortland));
  }

  async expectLeadsInPortlandHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.leadsInPortland), timeoutMs);
  }

  async expectLeadsInPortlandText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.leadsInPortland), expected, timeoutMs);
  }

  async expectLeadsInPortlandContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.leadsInPortland), substring, timeoutMs);
  }

  async expectLeadsInPortlandValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.leadsInPortland), value, timeoutMs);
  }

  async expectLeadsInPortlandEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.leadsInPortland), timeoutMs);
  }

  async expectLeadsInPortlandDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.leadsInPortland), timeoutMs);
  }

  async expectLeadsInPortlandChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.leadsInPortland), timeoutMs);
  }

  async expectLeadsInPortlandUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.leadsInPortland), timeoutMs);
  }

  async expectLeadsInPortlandFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.leadsInPortland), timeoutMs);
  }

  async expectLeadsInPortlandCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.leadsInPortland), count, timeoutMs);
  }

  async scrollLeadsInPortlandIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.leadsInPortland));
  }

  async clickContactsInCalifornia(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.contactsInCalifornia));
  }

  async doubleClickContactsInCalifornia(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.contactsInCalifornia));
  }

  async longPressContactsInCalifornia(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.contactsInCalifornia));
  }

  async expectContactsInCaliforniaHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.contactsInCalifornia), timeoutMs);
  }

  async expectContactsInCaliforniaText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.contactsInCalifornia), expected, timeoutMs);
  }

  async expectContactsInCaliforniaContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.contactsInCalifornia), substring, timeoutMs);
  }

  async expectContactsInCaliforniaValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.contactsInCalifornia), value, timeoutMs);
  }

  async expectContactsInCaliforniaEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.contactsInCalifornia), timeoutMs);
  }

  async expectContactsInCaliforniaDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.contactsInCalifornia), timeoutMs);
  }

  async expectContactsInCaliforniaChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.contactsInCalifornia), timeoutMs);
  }

  async expectContactsInCaliforniaUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.contactsInCalifornia), timeoutMs);
  }

  async expectContactsInCaliforniaFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.contactsInCalifornia), timeoutMs);
  }

  async expectContactsInCaliforniaCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.contactsInCalifornia), count, timeoutMs);
  }

  async scrollContactsInCaliforniaIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.contactsInCalifornia));
  }

  async doubleClickLearnMoreAboutNatural(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.learnMoreAboutNatural));
  }

  async longPressLearnMoreAboutNatural(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.learnMoreAboutNatural));
  }

  async expectLearnMoreAboutNaturalHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.learnMoreAboutNatural), timeoutMs);
  }

  async expectLearnMoreAboutNaturalText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.learnMoreAboutNatural), expected, timeoutMs);
  }

  async expectLearnMoreAboutNaturalContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.learnMoreAboutNatural), substring, timeoutMs);
  }

  async expectLearnMoreAboutNaturalValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.learnMoreAboutNatural), value, timeoutMs);
  }

  async expectLearnMoreAboutNaturalEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.learnMoreAboutNatural), timeoutMs);
  }

  async expectLearnMoreAboutNaturalDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.learnMoreAboutNatural), timeoutMs);
  }

  async expectLearnMoreAboutNaturalChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.learnMoreAboutNatural), timeoutMs);
  }

  async expectLearnMoreAboutNaturalUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.learnMoreAboutNatural), timeoutMs);
  }

  async expectLearnMoreAboutNaturalFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.learnMoreAboutNatural), timeoutMs);
  }

  async expectLearnMoreAboutNaturalCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.learnMoreAboutNatural), count, timeoutMs);
  }

  async scrollLearnMoreAboutNaturalIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.learnMoreAboutNatural));
  }
